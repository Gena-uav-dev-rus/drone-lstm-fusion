...
tmux send-keys -t drone:1 'export DISPLAY=:0 && export GZ_SIM_RESOURCE_PATH=~/PX4-Autopilot/Tools/simulation/gz/models:~/PX4-Autopilot/Tools/simulation/gz/worlds && gz sim -s -r ~/PX4-Autopilot/Tools/simulation/gz/worlds/baylands.sdf' Enter
...
tmux send-keys -t drone:6 'export DISPLAY=:0 && ~/QGroundControl.AppImage 2>/dev/null' Enter
tmux attach -t drone
